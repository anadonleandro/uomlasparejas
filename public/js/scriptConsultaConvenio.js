function filtrar() {
    ...
    if ($.fn.DataTable.isDataTable('#tablaConsultaConvenio')) {
        $('#tablaConsultaConvenio').DataTable().clear();
        $('#tablaConsultaConvenio').DataTable().destroy();
    }
    ...
    $.ajax({
        type: 'GET',
        url: 'consultaconvenio/resultado',
        data: {
        ...
        success: function (response) { // What to do if we succeed
            ...
            $('#tablaConsultaConvenio').dataTable({
...
function getDataCell() {
    var table = $('#tablaConsultaConvenio').DataTable();
    $('#tablaConsultaConvenio tbody').on('click', 'tr', function () {
