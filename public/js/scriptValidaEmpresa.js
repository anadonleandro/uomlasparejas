 // VALIDACIONES PARA EMPRESA CREATE
 function validaEmpresaCreate() {
     $("#empresa_create").ajaxSubmit({
         beforeSubmit: function () {
             $('#empresa_create').validate({
