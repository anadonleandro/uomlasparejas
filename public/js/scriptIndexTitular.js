        ...
        success: function (response) { // What to do if we succeed
            ...
            $('#tablaTitular').dataTable({
                ...
                buttons: [{
                        ...
                        title: ' LISTADO GENERAL DE TITULARES ',
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<form action= "titular/show" method="post"> <input hidden name="id_titular" id="id_titular" value="' + data + '" type="text"><input hidden name="_token" value="' + token + '" type="text"> <button type="submit" title="MOSTRAR TITULAR" class="btn btn-outline-primary"><i class="fas fa-eye"></i></button></form>'
                        }
                    },
                    {
                        "targets": 6,
                        ...
                        "className": 'dt-body-center',
                        "render": function (data, type, row, meta) {
                            return '<form action= "titular/edit" method="post"><input hidden name="id_titular" id="id_titular" value="' + data + '" type="text"><input hidden name="_token" value="' + token + '" type="text"><button type="submit" title="MODIFICAR TITULAR" class="btn btn-outline-secondary"><i class="fas fa-edit"></i></button></form>';
                        }
                    },
                    {
                        "targets": 7,
                        ...
                        "className": 'dt-body-center',
                        "render": function (data, type, row, meta) {
                            return '<form action= "listado/familiares" method="get"><input hidden name="id_titular" id="id_titular" value="' + data + '" type="text"><input hidden name="_token" value="' + token + '" type="text"><button type="submit" title="LISTADO DE FAMILIARES" class="btn btn-outline-success"><i class="fas fa-user"></i></button></form>';
                        }
                    }
                ]
            });
