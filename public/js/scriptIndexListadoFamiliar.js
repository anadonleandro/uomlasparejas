$(document).ready(function () {
    ...
    if ($.fn.DataTable.isDataTable('#tablaListadoFamiliar')) {
        $('#tablaListadoFamiliar').DataTable().clear();
        $('#tablaListadoFamiliar').DataTable().destroy();
    }
    ...
    $.ajax({
        ...
        success: function (response) { // What to do if we succeed
            ...
            $('#tablaListadoFamiliar').dataTable({
...
function getDataCell() {
    var table = $('#tablaListadoFamiliar').DataTable();
    $('#tablaListadoFamiliar tbody').on('click', 'tr', function () {
