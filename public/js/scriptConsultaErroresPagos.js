function filtrar() {
    ...
    if ($.fn.DataTable.isDataTable('#tablaConsultaErrores')) {
        $('#tablaConsultaErrores').DataTable().clear();
        $('#tablaConsultaErrores').DataTable().destroy();
    }
    ...
    $.ajax({
        ...
        success: function (response) { // What to do if we succeed
            ...
            $('#tablaConsultaErrores').dataTable({
...
function getDataCell() {
    var table = $('#tablaConsultaErrores').DataTable();
    $('#tablaConsultaErrores tbody').on('click', 'tr', function () {
