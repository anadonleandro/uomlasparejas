...
$(document).ready(function () {
    ...
    $.ajax({
            ...
            if (response.resultados == "error") {
                ...
                $('#tablaDeudaManual').dataTable({
                    ...
                    buttons: [{
                            ...
                            title: ' LISTADO GENERAL DE DEUDAS MANUALES ',
                    ...
                    "paging": true,
                    "scrollY": 380,
                    "order": [0, "DESC"], // ORDEN DE COLUMNAS
                    ...
                    columns: [{
                        ...
                        {
                            "data": "ipte_total_remuneracion"
                        },
                        {
                            "data": "ipte_depositado"
                        },
                        {
                            "data": "user"
                        },
                    ...
                    "columnDefs": [{
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, row, meta) {
                                return '<form action= "eliminaDeuda" method="post" id="pago_manual_delete"><input hidden name="id_deuda" id="id_deuda" value="' + data + '" type="text"><input hidden name="_token" value="' + token + '" type="text"><button type="button" title="ELIMINAR DEUDA" onclick="validaPagoManualDelete()" class="btn btn-outline-danger"><i class="far fa-trash-alt"></i></i></button></form>';
                            }
                        }
                    ]
                });
        ...
        error: function (_jqXHR, textStatus, errorThrown, response) { // What to do if we fail          
