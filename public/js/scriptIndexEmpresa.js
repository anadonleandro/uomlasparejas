        ...
        success: function (response) { // What to do if we succeed
            ...
            $('#tablaEmpresa').dataTable({
                ...
                buttons: [{
                        ...
                        title: ' LISTADO GENERAL DE EMPRESAS ',
                ...
                "columnDefs": [{
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, row, meta) {
                            return '<form action= "empresa/show" method="post"> <input hidden name="id_empresa" id="id_empresa" value="' + data + '" type="text"><input hidden name="_token" value="' + token + '" type="text"> <button type="submit" title="MOSTRAR EMPRESA" class="btn btn-outline-primary"><i class="fas fa-eye"></i></button></form>'
                        }
                    },
                    {
                        "targets": 9,
                        ...
                        "className": 'dt-body-center',
                        "render": function (data, type, row, meta) {
                            return '<form action= "empresa/edit" method="post"><input hidden name="id_empresa" id="id_empresa" value="' + data + '" type="text"><input hidden name="_token" value="' + token + '" type="text"><button type="submit" title="MODIFICAR EMPRESA" class="btn btn-outline-secondary"><i class="fas fa-edit"></i></button></form>';
                        }
                    }
                ]
            });
